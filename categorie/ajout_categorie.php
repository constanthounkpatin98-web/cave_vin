...
if(isset($_POST["libelle"]))
{
    ...
    {
        header("Location: ajout_categorie.php?erreur=1");
        exit();
    }

    $requete = $connexion->prepare("

    INSERT INTO categorie (libelle, description, statut)

    VALUES (?, ?, ?)

    ");

    $requete->execute([$libelle, $description, $statut]);

    header("Location: liste_categorie.php?ajout=ok");
    exit();
}
...
/* ============================================
   STYLES POUR LA PAGE D'AJOUT DE CATÉGORIE
   ============================================ */

.ajout-categorie-container {
    max-width: 800px;
    margin: 0 auto;
}

.ajout-categorie-card {
    border: none;
    border-radius: 8px;
...
.ajout-categorie-card .card-header {
    background: #0d6efd;
    color: white;
    padding: 1rem 1.5rem;
...
.ajout-categorie-card .card-header h3 {
    font-weight: 600;
    font-size: 1.25rem;
    margin: 0;
}

.ajout-categorie-card .card-body {
    padding: 1.5rem;
    background: white;
}

.ajout-categorie-card .form-label {
    font-weight: 500;
    font-size: 0.875rem;
    margin-bottom: 0.25rem;
}

.ajout-categorie-card .form-control,
.ajout-categorie-card .form-select {
...
.ajout-categorie-card .form-control:focus,
.ajout-categorie-card .form-select:focus {
    border-color: #0d6efd;
...
<div class="contenu-principal">
    ...
    <div class="zone-corps">
        ...
        <div class="ajout-categorie-container">
            ...
            <!-- ============================================
                 CARTE PRINCIPALE
                 ============================================ -->
            <div class="card ajout-categorie-card">

                <!-- Bandeau bleu -->
                <div class="card-header">
                    <h3><i class="bi bi-plus-circle me-2"></i>Ajouter une nouvelle catégorie</h3>
                </div>
