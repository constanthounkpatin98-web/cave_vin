...
//===============================================
// Récupération des catégories (même requête que l'original)
//===============================================
...
<title>Catégories — Gestion des Vins</title>
...
<aside class="barre-laterale" id="sidebar">
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_categorie.php" class="lien-nav actif"><i class="bi bi-tags"></i> Catégories</a>
    ...
    <div class="zone-corps">
        ...
        <div class="entete-page mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h2>Catégories</h2>
                    <p>Gère les catégories de vins de la cave</p>
                </div>
            </div>
            <a href="ajout_categorie.php" class="btn btn-primary bouton-nouveau">
        ...
        <div class="alert alert-danger d-flex align-items-start gap-2 mb-4">
            ...
            <div>
                <strong>Les catégories n'ont pas pu être chargées.</strong>
        ...
        <div class="alert alert-success">La catégorie a été enregistrée avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["modifier"])): ?>
        <div class="alert alert-info">La catégorie a été modifiée avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["supprimer"])): ?>
        <div class="alert alert-danger">La catégorie a été supprimée avec succès.</div>
        <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <div class="actions-ligne">
                                    <a href="modifier_categorie.php?id_categorie=<?php echo $ligne["id_categorie"]; ?>" class="btn btn-warning btn-sm">Modifier</a>
                                    <a href="supprimer_categorie.php?id_categorie=<?php echo $ligne["id_categorie"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Voulez-vous vraiment supprimer cette catégorie ?');">Supprimer</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
