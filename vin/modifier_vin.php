...
if(isset($_POST["nom_vin"]))
{
    ...
    {
        header("Location: modifier_vin.php?id_vin=".$id_vin."&erreur=1");
        exit();
    }

    // Gestion de l'upload d'une nouvelle photo (facultatif)
    ...
    SET nom_vin = ?, millesime = ?, pays_origine = ?, region = ?, couleur = ?, degre_alcool = ?,

    prix = ?, quantite_stock = ?, photo = ?, description = ?, statut = ?, id_categorie = ?
    ...
    header("Location: liste_vin.php?modifier=ok");
    exit();
}


//===============================================
// Récupération du vin à modifier
//===============================================
...
$requete_categorie = $connexion->query("SELECT * FROM categorie WHERE statut = 'Actif' ORDER BY libelle ASC");
...
.modifier-vin-card .card-header h3 {
    font-weight: 600;
    font-size: 1.25rem;
    margin: 0;
}

.modifier-vin-card .card-body {
    padding: 1.5rem;
    background: white;
}

.modifier-vin-card .form-label {
    font-weight: 500;
    font-size: 0.875rem;
    margin-bottom: 0.25rem;
}

.modifier-vin-card .form-control,
.modifier-vin-card .form-select {
...
.modifier-vin-card .form-control:focus,
.modifier-vin-card .form-select:focus {
    border-color: #0d6efd;
...
<div class="contenu-principal">
    ...
    <div class="zone-corps">
        ...
        <div class="modifier-vin-container">
            ...
            <!-- ============================================
                 CARTE PRINCIPALE
                 ============================================ -->
            <div class="card modifier-vin-card">

                <!-- Bandeau jaune -->
                <div class="card-header">
                    <h3><i class="bi bi-pencil-square me-2"></i>Modifier le vin</h3>
                </div>

                <!-- Corps avec le formulaire -->
                <div class="card-body">

                    <form action="modifier_vin.php" method="POST" enctype="multipart/form-data">

                        <input type="hidden" name="id_vin" value="<?php echo $vin["id_vin"]; ?>">
                        <input type="hidden" name="ancienne_photo" value="<?php echo htmlspecialchars($vin["photo"]); ?>">

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom du vin</label>
                                <input type="text" name="nom_vin" class="form-control" value="<?php echo htmlspecialchars($vin["nom_vin"]); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Millésime</label>
                                <input type="number" name="millesime" class="form-control" min="1900" max="2100" value="<?php echo htmlspecialchars($vin["millesime"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="pays_origine" class="form-control" value="<?php echo htmlspecialchars($vin["pays_origine"]); ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Région</label>
                                <input type="text" name="region" class="form-control" value="<?php echo htmlspecialchars($vin["region"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="couleur" required>
                                    <option value="Rouge" <?php echo $vin["couleur"] == "Rouge" ? "selected" : ""; ?>>Rouge</option>
                                    <option value="Blanc" <?php echo $vin["couleur"] == "Blanc" ? "selected" : ""; ?>>Blanc</option>
                                    <option value="Rosé" <?php echo $vin["couleur"] == "Rosé" ? "selected" : ""; ?>>Rosé</option>
                                    <option value="Effervescent" <?php echo $vin["couleur"] == "Effervescent" ? "selected" : ""; ?>>Effervescent</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Degré d'alcool (%)</label>
                                <input type="number" step="0.01" name="degre_alcool" class="form-control" value="<?php echo htmlspecialchars($vin["degre_alcool"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="prix" class="form-control" value="<?php echo htmlspecialchars($vin["prix"]); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Quantité en stock</label>
                                <input type="number" name="quantite_stock" class="form-control" value="<?php echo htmlspecialchars($vin["quantite_stock"]); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="id_categorie" required>
                                    <?php while($cat = $requete_categorie->fetch()): ?>
                                        <option value="<?php echo $cat["id_categorie"]; ?>" <?php echo $cat["id_categorie"] == $vin["id_categorie"] ? "selected" : ""; ?>><?php echo htmlspecialchars($cat["libelle"]); ?></option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="statut" required>
                                    <option value="Disponible" <?php echo $vin["statut"] == "Disponible" ? "selected" : ""; ?>>Disponible</option>
                                    <option value="Rupture" <?php echo $vin["statut"] == "Rupture" ? "selected" : ""; ?>>Rupture</option>
                                    <option value="Archivé" <?php echo $vin["statut"] == "Archivé" ? "selected" : ""; ?>>Archivé</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="photo-actuelle">
                                <?php if(!empty($vin["photo"])): ?>
                                    <img src="uploads/<?php echo htmlspecialchars($vin["photo"]); ?>" alt="photo" width="80">
                                <?php else: ?>
                                    <span class="text-muted">Aucune photo</span>
                                <?php endif; ?>
                                <span class="text-muted small">Laisser vide pour conserver la photo actuelle.</span>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="3"><?php echo htmlspecialchars($vin["description"]); ?></textarea>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="liste_vin.php" class="btn btn-annuler">Annuler</a>
                            <button type="submit" class="btn btn-mettre-a-jour"><i class="bi bi-pencil me-1"></i> Mettre à jour</button>
                        </div>
