...
// On réutilise la même requête déjà exécutée ci-dessus si possible,
// sinon on relance un comptage simple.
//===============================================
...
.bandeau-notification h3 {
    font-weight: 600;
    font-size: 1.25rem;
    margin: 0;
}

.bandeau-notification .btn-light {
    background: white;
    color: #0d6efd;
    border: none;
    font-weight: 500;
...
.bandeau-notification .btn-light:hover {
    background: #f0f0f0;
}

.bandeau-notification .btn-succes-bandeau {
    background: var(--vert);
    color: white;
    border: none;
    font-weight: 600;
...
.bandeau-notification .btn-succes-bandeau:hover { background:#128a3e; color:#fff; }
...
.notification-card .table thead th {
    background: #212529;
    color: white;
    border-color: #212529;
    font-weight: 600;
...
.notification-card .table td {
    padding: 0.75rem 0.75rem;
    vertical-align: middle;
    border-color: #dee2e6;
}

.notification-card .table-striped tbody tr:nth-of-type(odd) {
    background-color: rgba(0,0,0,0.02);
}

.notification-card .table-hover tbody tr:hover {
...
@media (max-width: 768px){
    ...
    .bandeau-notification h3{ font-size:1rem; }
    .bandeau-notification .btn-light{ font-size:0.75rem; padding:0.3rem 0.7rem; }
    .notification-card .card-body{ padding:0.8rem; }
    .notification-card .table{ font-size:0.8rem; }
}
...
@media (max-width: 576px){
    ...
    .bandeau-notification{ flex-direction:column; gap:.5rem; text-align:center; }
    .bandeau-notification h3{ font-size:0.9rem; }
...
<aside class="barre-laterale" id="sidebar">
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_notification.php" class="lien-nav actif"><i class="bi bi-bell"></i> Notifications</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end menu-notif p-0">
                    <div class="entete-menu-notif">
                        ...
                        <a href="liste_notification.php">Tout voir</a>
                    </div>
                    ...
                    <?php else: ?>
                        ...
                        <a href="liste_notification.php?id=<?php echo (int)$notif['id_notification']; ?>"
    ...
    <div class="zone-corps">
        ...
        <div class="notification-container">
            ...
            <div class="alert alert-success alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill me-2"></i> La notification a été envoyée avec succès.
            ...
            <div class="alert alert-danger alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill me-2"></i> La notification a été supprimée avec succès.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Fermer"></button>
            </div>
            <?php endif; ?>
            ...
            <div class="card notification-card">
                ...
                <div class="bandeau-notification">
                    <h3><i class="bi bi-bell me-2"></i>Notifications Envoyées</h3>
                    <a href="envoyer_notification.php" class="btn-succes-bandeau">
                        <i class="bi bi-plus-lg"></i> Nouvelle Notification
                    </a>
                </div>
                    ...
                    <div class="table-responsive-wrapper">
                        <table id="tableau" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $ligne["id_notification"]; ?></td>
                                    <td><?php echo htmlspecialchars($ligne["nom_client"] . " " . $ligne["prenom_client"]); ?></td>
                                    <td class="fw-semibold"><?php echo htmlspecialchars($ligne["titre"]); ?></td>
                                    <td><?php echo htmlspecialchars($ligne["message"]); ?></td>
                                    <td><?php echo htmlspecialchars($ligne["date_envoi"]); ?></td>
                                    <td>
                                        <?php
                                            $couleur_statut = 'secondary';
                                            if($ligne["statut"] === 'Non lue') $couleur_statut = 'warning';
                                            if($ligne["statut"] === 'Lue') $couleur_statut = 'success';
                                            if($ligne["statut"] === 'Envoyée') $couleur_statut = 'primary';
                                        ?>
                                        <span class="badge-statut bg-<?php echo $couleur_statut; ?>"><?php echo htmlspecialchars($ligne["statut"]); ?></span>
                                    </td>
                                    <td>
                                        <div class="cellule-actions">
                                            <a href="supprimer_notification.php?id_notification=<?php echo $ligne["id_notification"]; ?>" class="btn-supprimer" onclick="return confirm('Voulez-vous vraiment supprimer cette notification ?');">Supprimer</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
