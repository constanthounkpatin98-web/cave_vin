...
//===============================================
// Récupération des avis (avec infos client)
//===============================================
...
.bandeau-avis .btn-light:hover {
    background: #f0f0f0;
}

.bandeau-avis .btn-succes-bandeau {
    background: var(--vert);
    color: white;
    border: none;
    font-weight: 600;
...
.bandeau-avis .btn-succes-bandeau:hover { background:#128a3e; color:#fff; }
...
.avis-card .table-striped tbody tr:nth-of-type(odd) {
    background-color: rgba(0,0,0,0.02);
}

.avis-card .table-hover tbody tr:hover {
...
@media (max-width: 768px){
    ...
    .bandeau-avis h3{ font-size:1rem; }
    .bandeau-avis .btn-light{ font-size:0.75rem; padding:0.3rem 0.7rem; }
    .avis-card .card-body{ padding:0.8rem; }
    .avis-card .table{ font-size:0.8rem; }
}
...
@media (max-width: 576px){
    ...
    .bandeau-avis{ flex-direction:column; gap:.5rem; text-align:center; }
    .bandeau-avis h3{ font-size:0.9rem; }
...
.etoiles-note{ color:#f59e0b; letter-spacing:1px; white-space:nowrap; }
...
<aside class="barre-laterale" id="sidebar">
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_avis.php" class="lien-nav actif"><i class="bi bi-star"></i> Avis</a>
    ...
    <div class="zone-corps">
        ...
        <div class="avis-container">
            ...
            <div class="alert alert-info alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-info-circle-fill me-2"></i> Le statut de l'avis a été mis à jour.
            ...
            <div class="alert alert-danger alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill me-2"></i> L'avis a été supprimé avec succès.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Fermer"></button>
            </div>
            <?php endif; ?>
            ...
            <div class="card avis-card">
                ...
                <div class="bandeau-avis">
                    <h3><i class="bi bi-star me-2"></i>Liste des Avis</h3>
                </div>
                        ...
                        <table id="tableau" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="etoiles-note"><?php echo str_repeat("★", $ligne["note"]) . str_repeat("☆", 5 - $ligne["note"]); ?></td>
                                    <td><?php echo htmlspecialchars($ligne["commentaire"]); ?></td>
                                    <td><?php echo htmlspecialchars($ligne["date_avis"]); ?></td>
                                    <td>
                                        <?php
                                            $couleur_statut = 'secondary';
                                            if($ligne["statut"] === 'Publié') $couleur_statut = 'success';
                                            if($ligne["statut"] === 'En attente') $couleur_statut = 'warning';
                                            if($ligne["statut"] === 'Masqué') $couleur_statut = 'secondary';
                                        ?>
                                        <span class="badge-statut bg-<?php echo $couleur_statut; ?>"><?php echo htmlspecialchars($ligne["statut"]); ?></span>
                                    </td>
                                    <td>
                                        <div class="cellule-actions">
                                            <?php if($ligne["statut"] != "Publié"): ?>
                                            <a href="modifier_statut_avis.php?id_avis=<?php echo $ligne["id_avis"]; ?>&statut=Publié" class="btn-publier">Publier</a>
                                            <?php endif; ?>
                                            <?php if($ligne["statut"] != "Masqué"): ?>
                                            <a href="modifier_statut_avis.php?id_avis=<?php echo $ligne["id_avis"]; ?>&statut=Masqué" class="btn-masquer">Masquer</a>
                                            <?php endif; ?>
                                            <a href="supprimer_avis.php?id_avis=<?php echo $ligne["id_avis"]; ?>" class="btn-supprimer" onclick="return confirm('Voulez-vous vraiment supprimer cet avis ?');">Supprimer</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
