...
<title>Administrateurs — Gestion des Administrateurs</title>
...
<aside class="barre-laterale" id="sidebar">
    ...
    <div class="logo-app">
        <div class="icone-logo"><i class="bi bi-person-badge text-white"></i></div>
        <div>
            <div class="titre-logo">GESTION DES ADMINS</div>
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_admin.php" class="lien-nav actif"><i class="bi bi-person-badge"></i> Administrateurs</a>
...
<div class="contenu-principal">
    ...
    <div class="zone-corps">
        ...
        <div class="entete-page mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <p>Gère les comptes administrateurs de la plateforme</p>
                </div>
            </div>
            <a href="ajout_admin.php" class="btn btn-primary bouton-nouveau">
        ...
        <div class="alert alert-danger d-flex align-items-start gap-2 mb-4">
            ...
            <div>
                <strong>Les administrateurs n'ont pas pu être chargés.</strong>
        ...
        <div class="alert alert-success">L'administrateur a été enregistré avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["modifier"])): ?>
        <div class="alert alert-info">L'administrateur a été modifié avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["supprimer"])): ?>
        <div class="alert alert-danger">L'administrateur a été supprimé avec succès.</div>
        <?php endif; ?>

        <div class="carte">
            <div class="entete-carte">
                <h6>Tous les administrateurs</h6>
            </div>
                ...
                <table id="tableau" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($ligne["date_creation"]); ?></td>
                            <td>
                                <span class="badge rounded-pill <?php echo $ligne["statut"] === 'Actif' ? 'text-bg-success' : 'text-bg-secondary'; ?>">
                                    <?php echo htmlspecialchars($ligne["statut"]); ?>
                                </span>
                            </td>
                            <td class="text-nowrap">
                                <div class="actions-ligne">
                                    <a href="modifier_admin.php?id_admin=<?php echo $ligne["id_admin"]; ?>" class="btn btn-warning btn-sm">Modifier</a>
                                    <a href="supprimer_admin.php?id_admin=<?php echo $ligne["id_admin"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Voulez-vous vraiment supprimer cet administrateur ?');">Supprimer</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
