...
//===============================================
// Récupération des livraisons (avec commande + client)
//===============================================
...
$requete = $connexion->query("
    ...
    ORDER BY livraison.id_livraison DESC
");

$livraisons = $requete->fetchAll();


//===============================================
// Fonction pour la couleur du badge de statut
//===============================================
...
<aside class="barre-laterale" id="sidebar">
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_livraison.php" class="lien-nav actif"><i class="bi bi-truck"></i> Livraisons</a>
    ...
    <div class="zone-corps">
        ...
        <div class="liste-commande-container">
            ...
            <div class="alert alert-info alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-info-circle-fill me-2"></i> La livraison a été mise à jour avec succès.
            ...
            <div class="alert alert-danger alert-custom alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill me-2"></i> La livraison a été supprimée avec succès.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Fermer"></button>
            </div>
            <?php endif; ?>

            <!-- ============================================
                 CARTE PRINCIPALE - IDENTIQUE À LA LISTE DES CLIENTS
                 ============================================ -->
            <div class="card liste-commande-card">

                <!-- Bandeau bleu -->
                <div class="bandeau-commande">
                    <h3><i class="bi bi-truck me-2"></i>Liste des Livraisons</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="tableau" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <?php foreach($livraisons as $ligne): ?>
                            <tr>
                                <td><?php echo $ligne["id_livraison"]; ?></td>
                                <td>#<?php echo $ligne["id_commande"]; ?></td>
                                <td><?php echo htmlspecialchars(($ligne["prenom"] ?? "") . " " . ($ligne["nom"] ?? "")); ?></td>
                                <td><?php echo htmlspecialchars($ligne["adresse_livraison"]); ?></td>
                                <td><?php echo number_format($ligne["frais_livraison"], 0, ',', ' '); ?> FCFA</td>
                                <td><?php echo !empty($ligne["date_livraison"]) ? htmlspecialchars($ligne["date_livraison"]) : "—"; ?></td>
                                <td><?php echo !empty($ligne["num_suivi"]) ? htmlspecialchars($ligne["num_suivi"]) : "—"; ?></td>
                                <td>
                                    <span class="badge rounded-pill text-bg-<?php echo couleur_statut_livraison($ligne["statut"]); ?>"><?php echo htmlspecialchars($ligne["statut"]); ?></span>
                                </td>
                                <td class="text-nowrap">
                                    <div class="actions-ligne">
                                        <a href="modifier_livraison.php?id_livraison=<?php echo $ligne["id_livraison"]; ?>" class="btn btn-modifier">Modifier</a>
                                        <a href="supprimer_livraison.php?id_livraison=<?php echo $ligne["id_livraison"]; ?>" class="btn btn-supprimer" onclick="return confirm('Voulez-vous vraiment supprimer cette livraison ?');">Supprimer</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
