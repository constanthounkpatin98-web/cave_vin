...
//===============================================
// Récupération des notifications du client
//===============================================
...
//===============================================
// Marquer automatiquement toutes les notifications comme lues à la consultation
//===============================================

$requete_maj = $connexion->prepare("

UPDATE notification SET statut = 'Lue' WHERE id_client = ? AND statut != 'Lue'

");

$requete_maj->execute([$id_client]);
...
//===============================================
// Notifications non lues restantes (0 après la mise à jour ci-dessus)
//===============================================
...
//===============================================
// Vérifier si le client a déjà passé au moins une commande
//===============================================
...
<style>
    ...
    .ligne-notif:hover {
        ...
        box-shadow: 0 6px 16px rgba(28,20,20,.07);
...
<div class="fil-ariane">
    ...
    <div class="container">
        ...
        <span class="actif">Mes notifications</span>
...
$aucune_notification = true;

while($ligne = $requete->fetch())
{
    $aucune_notification = false;

    $classe_lue = $ligne["statut"] == "Non lue" ? "non-lue" : "";

?>

<div class="ligne-notif <?php echo $classe_lue; ?> mb-2 p-3">

<div class="d-flex gap-3">

<div class="pastille-notif">
...
<h6 class="titre-notif mb-1"><?php echo htmlspecialchars($ligne["titre"]); ?></h6>

<small class="text-muted"><?php echo htmlspecialchars($ligne["date_envoi"]); ?></small>

</div>

<p class="mb-0"><?php echo htmlspecialchars($ligne["message"]); ?></p>
