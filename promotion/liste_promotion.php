...
<title>Promotions — Gestion des Promotions</title>
...
<aside class="barre-laterale" id="sidebar">
    ...
    <div class="logo-app">
        <div class="icone-logo"><i class="bi bi-percent text-white"></i></div>
        <div>
            <div class="titre-logo">GESTION DES PROMOTIONS</div>
    ...
    <nav class="nav-laterale">
        ...
        <a href="liste_promotion.php" class="lien-nav actif"><i class="bi bi-percent"></i> Promotions</a>
    ...
    <div class="zone-corps">
        ...
        <div class="entete-page mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h2>Promotions</h2>
                    <p>Gère les offres et remises en cours</p>
                </div>
            </div>
            <a href="ajout_promotion.php" class="btn btn-primary bouton-nouveau">
        ...
        <div class="alert alert-danger d-flex align-items-start gap-2 mb-4">
            ...
            <div>
                <strong>Les promotions n'ont pas pu être chargées.</strong>
        ...
        <div class="alert alert-success">La promotion a été enregistrée avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["modifier"])): ?>
        <div class="alert alert-info">La promotion a été modifiée avec succès.</div>
        <?php endif; ?>

        <?php if(isset($_GET["supprimer"])): ?>
        <div class="alert alert-danger">La promotion a été supprimée avec succès.</div>
        <?php endif; ?>

        <div class="carte">
            <div class="entete-carte">
                <h6>Toutes les promotions</h6>
            </div>
            <div class="corps-carte">
                ...
                <table id="tableau" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $ligne["id_promotion"]; ?></td>
                            <td class="fw-semibold"><?php echo htmlspecialchars($ligne["libelle"]); ?></td>
                            <td><?php echo htmlspecialchars($ligne["type_remise"]); ?></td>
                            <td><?php echo $ligne["type_remise"] == "Pourcentage" ? $ligne["valeur_remise"]."%" : number_format($ligne["valeur_remise"], 0, ',', ' ')." FCFA"; ?></td>
                            <td><?php echo htmlspecialchars($ligne["date_debut"]); ?></td>
                            <td><?php echo htmlspecialchars($ligne["date_fin"]); ?></td>
                            <td>
                                <span class="badge rounded-pill <?php echo $ligne["statut"] === 'Active' ? 'text-bg-success' : 'text-bg-secondary'; ?>">
                                    <?php echo htmlspecialchars($ligne["statut"]); ?>
                                </span>
                            </td>
                            <td class="text-nowrap">
                                <div class="actions-ligne">
                                    <a href="modifier_promotion.php?id_promotion=<?php echo $ligne["id_promotion"]; ?>" class="btn btn-warning btn-sm">Modifier</a>
                                    <a href="supprimer_promotion.php?id_promotion=<?php echo $ligne["id_promotion"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Voulez-vous vraiment supprimer cette promotion ?');">Supprimer</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
